//manages the page's scroll position for both new page navigations and internal anchor links within the same page
...
export function ScrollToTop() {
  ...
  const prevLocationRef = useRef(null); // Removed <string | null> type
